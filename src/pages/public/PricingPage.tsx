...
export const PricingPage: React.FC = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      name: 'Micro Plan',
      price: '189',
      period: 'บาท / เดือน (รวม VAT)',
      limit: 'ไม่เกิน 25 ห้อง',
      desc: 'เหมาะสำหรับอพาร์ตเมนต์ขนาดเล็ก',
      popular: false,
      features: [
        'สูงสุด 25 ห้องพัก',
        'ครบทุกฟีเจอร์ใน Free Plan',
        'ระบบตรวจสลิปโอนเงิน PromptPay',
        'ระบบแจ้งซ่อมแซมสองทาง',
        'จำกัดบทบาทพนักงาน 2 บัญชี'
      ]
    },
    {
      id: 'small',
      ...
      price: '529',
      period: 'บาท / เดือน (รวม VAT)',
      limit: 'ไม่เกิน 50 ห้อง',
      desc: 'เหมาะสำหรับหอพักขนาดกลางยอดนิยม',
      popular: true,
      features: [
        'สูงสุด 50 ห้องพัก',
        'ครบทุกฟีเจอร์ใน Micro Plan',
        'ระบบสถิติและรายงานงบการเงิน',
        'ผู้ใช้งานพนักงานไม่จำกัด',
    ...
    },
    {
      ...
      price: '999',
      period: 'บาท / เดือน (รวม VAT)',
      limit: 'ไม่เกิน 100 ห้อง',
      desc: 'เหมาะสำหรับอาคารพักอาศัยขนาดใหญ่',
      popular: false,
      features: [
        'สูงสุด 100 ห้องพัก',
        'ครบทุกฟีเจอร์ระดับสูง',
        'ส่งประกาศและแจ้งเตือนไม่จำกัด',
        'บันทึก Audit Logs ประวัติย้อนหลัง',
    ...
    },
    {
      ...
      price: '1,799',
      period: 'บาท / เดือน (รวม VAT)',
      limit: 'ไม่เกิน 200 ห้อง',
      desc: 'สำหรับคอมเพล็กซ์หอพักหลายอาคาร',
      popular: false,
      features: [
        'สูงสุด 200 ห้องพัก',
        'การจัดการหลายอาคารพร้อมกัน',
        'ส่งออกรายงานไฟล์ Excel/CSV',
    ...
    },
    {
      ...
      desc: 'สำหรับโครงการอสังหาริมทรัพย์และเครือหอพักใหญ่',
      popular: false,
      features: [
        'ไม่จำกัดจำนวนห้องพักและอาคาร',
        'ครบทุกฟีเจอร์ระดับพรีเมียม',
        'Custom Domain & Branding',
        'API & Webhook Custom Integration',
        'SLA Support 24/7'
      ]
    }
  ];
