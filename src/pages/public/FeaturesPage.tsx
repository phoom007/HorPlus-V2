...
export const FeaturesPage: React.FC = () => {
  const featureCategories = [
    ...
    },
    {
      id: 'payments',
      icon: FileCheck2,
      title: '6. ตรวจสอบการชำระเงินและสลิป',
      desc: 'นิติตรวจสอบสลิปโอนเงิน PromptPay และอนุมัติรับเงิน',
      bullets: [
        'แสดงรายการชำระเงินรอตรวจสอบ',
        'เปิดดูรูปภาพสลิปที่ผู้เช่าแนบส่งมาจากมือถือ',
        'กดยืนยันชำระเงินเพื่อเปลี่ยนสถานะบิลเป็นชำระแล้ว'
      ]
    },
    {
      id: 'receipts',
      icon: Receipt,
      title: '7. ออกใบเสร็จรับเงิน',
      desc: 'สร้างใบเสร็จรับเงินอิเล็กทรอนิกส์ส่งถึงผู้เช่าอัตโนมัติ',
      bullets: [
        'ออกรหัสใบเสร็จมาตรฐานแยกตามลำดับปีเดือน',
        'ผู้เช่าสามารถดาวน์โหลดและพิมพ์ใบเสร็จย้อนหลังได้ตลอดเวลา',
        'บันทึกประวัติการออกใบเสร็จป้องกันการแก้ไขดัดแปลง'
      ]
    },
    {
      id: 'maintenance',
